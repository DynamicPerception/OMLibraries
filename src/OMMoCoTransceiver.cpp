 ...
 *
 * */
char OMMoCoTransceiver::Init(uint8_t ucPort, uint8_t ucBusAddress,
 ...
 * */
char OMMoCoTransceiver::Receive(uint8_t * pucRcvAddress, uint8_t ** pucFrame,
	...
	//&& ( usMBCRC16( ( UCHAR * ) ucRTUBuf, usRcvBufferPos ) == 0 ) )
	{
		...
		*pucRcvAddress = ucRTUBuf[OM_PDU_ADDR_OFF];
		 ...
		 */
		*pusLength = (unsigned short) (usRcvBufferPos - OM_PDU_PDU_OFF
				- OM_PDU_SIZE_CRC);
 ...
 *
 * */
char OMMoCoTransceiver::Send(uint8_t ucSlaveAddress, const uint8_t * pucFrame,
