...
enum : uint8_t { ITEM_MENU, ITEM_VALUE, ITEM_ACTION };
enum : uint8_t { MENU_ANALOG, MENU_DIGITAL };
enum : uint8_t { BUTTON_NONE, BUTTON_FORWARD, BUTTON_BACK, BUTTON_INCREASE, BUTTON_DECREASE, BUTTON_SELECT, BUTTON_HELD };
enum : uint8_t { CHANGE_DISPLAY, CHANGE_UP, CHANGE_DOWN, CHANGE_SAVE, CHANGE_ABORT };
enum : uint8_t { TYPE_BYTE, TYPE_INT, TYPE_UINT, TYPE_LONG, TYPE_ULONG, TYPE_FLOAT, TYPE_FLOAT_10, TYPE_FLOAT_100, TYPE_FLOAT_1000, TYPE_SELECT,
                 TYPE_BFLAG };
enum : uint8_t { MODE_INCREMENT, MODE_DECREMENT, MODE_NOOP };
