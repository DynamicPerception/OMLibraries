...
#ifndef	OM_COMHANDLER_AT90USB_H
#define OM_COMHANDLER_AT90USB_H
...
/**
 ...
 OMC_COM1   12   //PB4   //2    pD2
 OMC_COM2   25   //PD1   //3    PD3
 OMC_COM3   24   //PD0   //19   PC5

  Defines for pin change interrupt handling

 OMC_PCVECT     PCVECT???? //PCINT1_vect
 OMC_PCFLAG     PCFLAG???? //PCICR
 OMC_PCENABLE   PCIE1????? //PCIE1
 OMC_PCMASK     PCMSK1???? //PCMSK1
 OMC_PCINT      PCINT13??? //PCINT13
 OMC_PCREG      PINC?????? //PINC
 OMC_PCPIN      PINC5????? //PINC5
...
public:
	...
	OMComHandler_AT90USB(); // constructor
